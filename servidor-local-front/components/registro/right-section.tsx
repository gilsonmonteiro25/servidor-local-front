...
export const RightSectionRegistro = () => {
    ...
    console.log({ nome: nome, numero_identificaco: numeroIdentificacao, dataNascimento: DataNascimento, email: email, password: password, pais: pais, localidade: localidade, telefone: telefone, role: role });
