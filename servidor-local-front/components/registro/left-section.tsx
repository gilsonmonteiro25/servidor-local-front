...
export const LeftSectionRegistro = () => {
    return(
        ...
        <p className="text-lg font-semi-normal text-grey-600">Join Servidor Local to experience a curated ecosystem connecting 
        ...
        <div className="flex justify-evenly gap-5 w-full">
            <Card className="px-3 py-7">
               <CardHeader>
                ...
                <CardContent>
                    <CardTitle className="font-semiblod">Vetted Network</CardTitle>
                    <CardDescription>
            ...
            <Card className="px-3 py-7">
                ...
                <CardContent>
                    <CardTitle className="font-semiblod">Secured Platform</CardTitle>
                    <CardDescription>
